  ...
  switch (type) {
    case 1:
      if (ele.src.includes('https://cn.gravatar.com/avatar')) {
        ele.src = ele.src.replace('https://cn.gravatar.com/avatar/', 'https://cdn.jsdelivr.net/gh/zelofv/cdn/img/other/gravatar.jpg')
      } else {
        ele.src = 'https://cdn.jsdelivr.net/gh/zelofv/cdn/img/other/default_avatar.jpg'
      }
      break
    case 2:
      ele.src = 'https://cdn.jsdelivr.net/gh/zelofv/cdn/img/other/default_gavatar.jpg'
      break
    case 3:

      ele.src = 'https://cdn.jsdelivr.net/gh/zelofv/cdn/img/other/image-404.png'
      break
    default:
      ele.src = 'https://cdn.jsdelivr.net/gh/zelofv/cdn/img/other/image-404.png'
  }
...
function checkBgImgCookie () {
  ...
  if (bgurl != '') {
    if (bgurl == 'https://cdn.jsdelivr.net/gh/zelofv/cdn/img/themebg/sakura.png' || bgurl == 'https://cdn.jsdelivr.net/gh/zelofv/cdn/img/themebg/plaid.jpg' || bgurl == 'https://cdn.jsdelivr.net/gh/zelofv/cdn/img/themebg/star.png' || bgurl == 'https://cdn.jsdelivr.net/gh/zelofv/cdn/img/themebg/point.png' || bgurl == 'https://cdn.jsdelivr.net/gh/zelofv/cdn/img/themebg/little-monster.png') {
...
$(document).ready(function () {
  ...
  changeBG('#sakura-bg', 'https://cdn.jsdelivr.net/gh/zelofv/cdn/img/themebg/sakura.png')
  changeBG('#gribs-bg', 'https://cdn.jsdelivr.net/gh/zelofv/cdn/img/themebg/plaid.jpg')
  changeBG('#pixiv-bg', 'https://cdn.jsdelivr.net/gh/zelofv/cdn/img/themebg/star.png')
  changeBG('#KAdots-bg', 'https://cdn.jsdelivr.net/gh/zelofv/cdn/img/themebg/point.png')
  changeBG('#totem-bg', 'https://cdn.jsdelivr.net/gh/zelofv/cdn/img/themebg/little-monster.png')
  ...
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true
    mashiro_global.variables.isNight = true
    $('body').css('background-image', 'url(https://cdn.jsdelivr.net/gh/zelofv/cdn/img/other/starry_sky.png)')
